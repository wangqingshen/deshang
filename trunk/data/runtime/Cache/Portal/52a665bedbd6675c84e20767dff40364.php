...
<div id="about-us-wrapper" class="ds-part">
	<div class="us-bg" style="background:url(/themes/simplebootx/Public/images/us_bg.png) no-repeat center;"></div>
	<div id="yb" class="list-item">
		<div class="list-item-logo" style="background:url('/themes/simplebootx/Public/images/ybkj.png') no-repeat center;"></div>
		<div class="list-item-title">
			<em></em>
			<span>优贝空间</span>
		</div>
		<div class="list-item-desc">
		优贝空间是成都首家投资驱动型新锐孵化器。我们依托于拥有雄厚资本实力的德商资本及配套基金，为国内、国际的优质创新创业项目提供“投前孵化”及“投后加速”管理服务。我们致力于寻找最好的项目，并以“基金+孵化”的模式助力创业者，为优秀创业者提供从种子轮、天使轮直到Pre-IPO的长期资本支持，用资本为入孵项目持续护航。<br>
		优贝空间致力于寻找具有全球视野和创新能力的优秀创业者，并根据不同项目所处不同阶段而提供需要的各种资源及管理服务，从而让每一个入驻团队享受到我们提供的最优质的深度价值服务。团队入驻后拥有的不止是简单的办公空间和基础服务，我们更以成都为出口，结合国内及国际化的优质投资机构，对接全球一线合作伙伴，用资金和资源为企业提供长期发展支持，助推项目迅速成长，提升价值。
		</div>
	</div>
	<div id="jd" class="list-item">
		<div class="list-item-logo" style="background:url('/themes/simplebootx/Public/images/jdjj.png') no-repeat center;"></div>
		<div class="list-item-title">
			<em></em>
			<span>奇点基金</span>
		</div>
		<div class="list-item-desc">
		奇点基金是成立于2015年5月，第一期募资1亿元，是成都最早布局移动互联网+创投机构之一，关注于移动互联网、TMT、智能硬件、大健康、工具软件、旅游、体育等领域的成长期创业项目。目前已在短时间内赢得业内良好口碑，是国内首屈一指的专业创投基金。<br>
	...
	<div id="ck" class="list-item">
		<div class="list-item-logo" style="background:url('/themes/simplebootx/Public/images/ckjj.png') no-repeat center;"></div>
		<div class="list-item-title">
			<em></em>
			<span>创客基金</span>
		</div>
